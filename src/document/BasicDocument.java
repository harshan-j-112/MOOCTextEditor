...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		//getTokens([a-z][A-Z]).size()
		//System.out.println(getTokens("[^0-9(), .!;?]+"));
	    return (getTokens("[^0-9(), .!;?]+").size());
	}
	...
	public static void main(String[] args)
	{
		...
		testCase(new BasicDocument("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);
	/*Document temp = new BasicDocument("sentence, with, lots, of, commas.!  "
	        + "(And some poaren)).  The output is: 7.5.");
	System.out.println(temp.getFleschScore());*/
